...
class Account_Types(models.Model):
    ...
    normal_balance = models.CharField(max_length=10, choices=BALANCE)
...
class Accounts(models.Model):
    ...
    company_id = models.ForeignKey(Company, unique=True, on_delete=models.CASCADE)
    account_number = models.CharField(max_length=20, unique=True)
    account_name = models.CharField(max_length=255)
    account_type_id = models.ForeignKey(Account_Types, on_delete=models.CASCADE)
    parent_account_id = models.ForeignKey('self', on_delete=models.CASCADE)
