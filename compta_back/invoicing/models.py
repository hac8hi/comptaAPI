...
class Invoices(models.Model):
    ...
    company_id = models.ForeignKey(Company, on_delete=models.CASCADE, related_name='company_contact')
...
class Invoices_Lines(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    invoice_id = models.ForeignKey(Invoices, on_delete=models.CASCADE, related_name='invoice_lines')
